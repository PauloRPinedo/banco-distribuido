...
| Replicación y elección | Log de replicación, quórum, heartbeat, voto, fencing por epoch; también dispara la revisión periódica de interés (RF-23/RF-24) | Por construir aquí. Implementado y probado en `prototipo-2/` sobre la pila antigua (`docs/SPECS.md` 11.10); el Prototipo 1 de hoy no tiene ninguno |
